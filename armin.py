...
def preprocessing_splitting_scaling(dataframe):
...
def main():
    ...
    # X_train, y_train, X_test, y_test = preprocessing_splitting_scaling(df_cdc_encode)
    # X_train_blnc_smote, y_train_blnc_smote = balance_data('smote', X_train, y_train)
    # cv = k_fold_cross_validation(10)
    # fit_model('knn', X_train_blnc_smote, y_train_blnc_smote, cv, 'G:\\My Drive\\knn_smote_2.pkl')
    # fit_model('nb' , X_train_blnc_smote, y_train_blnc_smote, cv, 'G:\\My Drive\\nb.pkl')
    # load_model_knn = load_model('G:\\My Drive\\knn_smote_2.pkl')
    # load_model_nb  = load_model('G:\\My Drive\\nb.pkl')
    # save to csv
    # score_model(X_test, y_test, load_model_knn)
    # score_model(X_test, y_test, load_model_nb)
